...
thresholds = [(1, 23, -33, 10, -26, 37),
              (0, 19, -39, 15, -16, 41)] # generic_blue_thresholds
...
while(True):
    ...
    clock.tick()
    img = sensor.snapshot()
    for blob in img.find_blobs(thresholds, roi=(0, 160, 320, 80), pixels_threshold=200, area_threshold=200):
